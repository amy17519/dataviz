...
- Visualization Process 
  - Making *_exploratory_* Graph*_s_*
  - Making a *_confirmatory_* Graph
...
- In this stage, we only care about *_informativeness_*! We will worry about Clarity and Aesthestics in next statge.
